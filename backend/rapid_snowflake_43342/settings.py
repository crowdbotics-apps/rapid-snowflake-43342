"""
Django settings for rapid_snowflake_43342 project.
...
ROOT_URLCONF = 'rapid_snowflake_43342.urls'
...
WSGI_APPLICATION = 'rapid_snowflake_43342.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rapid_snowflake_43342 API",
    "DESCRIPTION": "API documentation for rapid_snowflake_43342 App",
    "VERSION": "v1",
}
